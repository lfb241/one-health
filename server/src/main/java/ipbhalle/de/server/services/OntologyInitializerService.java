...
import ipbhalle.de.server.data.enums.Cardinality;
import ipbhalle.de.server.data.enums.DataType;
...
import ipbhalle.de.server.services.interfaces.IOntologyInitializerService;
