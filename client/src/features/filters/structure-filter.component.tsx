...
const ChemicalStructureFilter: React.FC<FilterComponentProps> = ({
    filterInfo,
    onChange,
}) => {
    const options = Object.entries(StructureFilterMatchMode).map(
        ([key, value]) => {
    ...
    useEffect(() => {
        onChange({
            ...filterInfo,
            matchMode: Object.keys(StructureFilterMatchMode)[1],
        });
    }, []);
        ...
        <div>
            ...
            <div className="p-inputgroup flex-1">
                ...
                <Dropdown
                    ...
                    onChange={(e) =>
                        onChange({ ...filterInfo, matchMode: e.value })
                    }
                />
            </div>
            <OverlayPanel
